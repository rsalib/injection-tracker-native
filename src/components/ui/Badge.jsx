...
const COLOR_MAP = {
  blue:   { bg: 'rgba(59, 130, 246, 0.15)',  text: '#93c5fd', border: 'rgba(59, 130, 246, 0.3)',  glow: '0 0 4px rgba(34, 211, 238, 0.4)' },
  green:  { bg: 'rgba(34, 197, 94, 0.15)',   text: '#86efac', border: 'rgba(34, 197, 94, 0.3)',   glow: '0 0 4px rgba(16, 185, 129, 0.4)' },
